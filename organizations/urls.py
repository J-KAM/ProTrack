...
urlpatterns = [
    url(r'^$', login_required(views.OrganizationPreview.as_view()), name="preview"),
    url(r'^new/$', views.OrganizationFormView.as_view(), name="create"),
    url(r'^(?P<id>[0-9]+)/$', views.OrganizationUpdate.as_view(), name="update"),
    url(r'^(?P<id>[0-9]+)/details/$', login_required(views.OrganizationDetails.as_view()), name="details"),
