...
urlpatterns = [
    url(r'^all/$', login_required(views.IssuePreview.as_view()), name="preview_all"),
    url(r'^assigned/$', login_required(views.IssuePreview.as_view()), name="preview_assigned"),
    url(r'^(?P<project_id>[0-9]+)/new/$', views.IssueFormView.as_view(), name="create"),
    url(r'^(?P<id>[0-9]+)/$', views.IssueUpdate.as_view(), name="update"),
    url(r'^(?P<id>[0-9]+)/details/$', login_required(views.IssueDetails.as_view()), name="details"),
